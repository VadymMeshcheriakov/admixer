"use strict";
class Player {
    constructor(videoContainer, url) {
        this.url = url;
    ...
    async showPlayerWithControls() {
        ...
        const width = parseInt(xmlVideoElement.getAttribute('width'), 10);
        this.video.src = xmlVideoElement.textContent;
    ...
    showControls() {
        ...
        this.buttonWrapper.append(this.playButton, this.pauseButton, this.closeButton);
    }
    removeControls() {
